...
abstract interface class GetAPODFavoriteListUseCaseContract
    implements UseCase<List<APODNasaModel>, void> {}

class GetAPODFavoriteListFromSharedPreferencesUseCase implements GetAPODFavoriteListUseCaseContract {
  final SharedPreferences _prefs;
  GetAPODFavoriteListFromSharedPreferencesUseCase({required SharedPreferences prefs})
      : _prefs = prefs;
